...
class AdminController {
    ...
    getCounts(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const users = yield adminService_1.default.findUsersCount();
                const vendors = yield adminService_1.default.findVendorsCount();
                const booking = yield adminService_1.default.findBookingCount();
