...
const HotelVerifyEmail = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      {
        axiosInstanceHotel
              .post(`${BASE_URL}/api/hotel/verify`, values, {
  ...
  const handleResendOtp = async () => {
   axiosInstanceHotel
          .get(`${BASE_URL}/api/hotel/resendOtp`, { withCredentials: true })
          .then((response) => {
            startTimer();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-2">Hotel Verify OTP</h2>
...
export default HotelVerifyEmail;
