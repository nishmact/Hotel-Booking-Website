  ...
  return (
    ...
    >
      ...
      <div className="flex gap-1">
        <button className="w-2/3 bg-black text-white h-full p-2 font-bold text-xl hover:bg-gray-900">
          Search
        </button>
        <button
          type="button"
          className="w-1/3 bg-black text-white h-full p-2 font-bold text-xl hover:bg-gray-900"
          onClick={handleClear}
        >
          Clear
        </button>
